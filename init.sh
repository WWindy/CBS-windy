...
if [ ! -z "${VIRTUAL_ENV}" ]; then
    ...
    apt-key adv --keyserver hkp://keyserver.ubuntu.com:80 --recv A4B469963BF863CC
    $SUDO apt update
    ...
    $SUDO npm --registry http://registry.npmmirror.com install -g --unsafe-perm=true --allow-root npm
